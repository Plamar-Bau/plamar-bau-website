        ...
        <div className="mx-auto mt-12 grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-4">
          {areas.map((a, i) => (
            <Reveal key={a} delay={(i % 4) * 70} className="h-full">
              <div className="flex h-full items-center gap-2.5 rounded-xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm transition hover:border-accent/50 hover:bg-white/15">
