...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh-97px)] max-w-7xl flex-col px-6 pt-6 pb-8 lg:min-h-[calc(100dvh-6.5rem)] lg:justify-end lg:pt-28 lg:pb-10">
